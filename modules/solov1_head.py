...
class SOLOv1Head(nn.Module):
    ...
    def __init__(self,
                 ...
                 stacked_convs=7,        #solov2 light set 2
                 strides=(8, 8, 16, 32, 32),  # [8, 8, 16, 32, 32],
    ...
    def _init_layers(self):
        ...
        for i in range(self.stacked_convs):          
            ...
            self.ins_convs.append(nn.Sequential(
                nn.Conv2d(
                    chn,
